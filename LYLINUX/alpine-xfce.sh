...
pid=$!
          ...
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Al"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alp"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpi"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpin"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpine"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpine L"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpine Li"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpine Lin"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpine Liu"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpine Linu"
          sleep 0.5
          #LWINGYI && YURI#7
          printf "\r Welcome  To Alpine Linux"
          sleep 0.5
echo
          #LWINGYI && YURI#1
          printf "\r M"
